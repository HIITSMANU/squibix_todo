      ...
      {/* <div className="flex flex-col sm:flex-row items-center my-5 gap-2">
            ...
            <div className="flex flex-col sm:flex-row my-2 gap-4 justify-between">
                        <div className="flex flex-col flex-1">
                            <p className='text-gray-400 text-[14px] italic'><span className='text-red-600'></span></p>
                            <div className='flex flex-row flex-1 items-center '>
                                <input  className={`w-full px-4 py-2 rounded border bg-gray-300  focus:outline-none focus:ring-2 focus:ring-orange-500`} type="text"  />
                        ...
                        <div className="flex-1">
                            <div className="flex-1 flex-col">
                                <p className='text-gray-400 text-[14px] italic'><span className='text-red-600'></span></p>
                                <select  className={`w-full px-1 py-2 rounded border bg-gray-300`}>
                    ...
                    <div className="flex flex-col sm:flex-row my-5 gap-4 justify-between">
                        <div className="flex flex-1 flex-col">
                            <p className='text-gray-400 text-[14px] italic bg-gray-300'><span className='text-red-600'></span></p>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between gap-2 mb-4">
                        <div className="flex flex-1 flex-col">
                            <p className='text-gray-400 text-[14px] italic'><span className='text-red-600'></span></p>
                            <select  className={`flex-1 px-4 py-2 rounded border bg-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500`}>
                                
                            </select>
                        </div>
                        <div className="flex flex-1 flex-col">
                            <p className='text-gray-400 text-[14px] italic'><span className='text-red-600'></span></p>
                            <select className={`flex-1 px-4 py-2 rounded border  focus:outline-none focus:ring-2 focus:ring-orange-500 bg-gray-300`}>
